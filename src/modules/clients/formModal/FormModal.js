...
export default function FormModal({ ctaUpdateHandler,
  profileImg, uploadImage, loading, imgDeleteHandler, name, setName
  , contact, setContact,
  address, setAddress,
  email, setEmail,
  submitLoading,
      ...
      <Dialog open={state.openFormModal} onClose={handleCloseUpdate} fullScreen={fullScreen} fullWidth={true} BackdropProps={{ style: { backgroundColor: 'rgba(0, 0, 0, 0.4)', backdropFilter: 'blur(8px)' } }}>
          ...
          <Box >
            ...
            <FM.LabelText>Profile picture*</FM.LabelText>
            {
              loading ?
                ...
                :
                !profileImg ?
                  <FM.ImageUploaderBtn variant="secondary" profileImg={profileImg} component="label">
                    <IconButton color="default" aria-label="upload picture" component="label">
                      <input onChange={(e) => uploadImage(e)} hidden accept="image/*" type="file" />
        ...
        <DialogActions>
          <Stack direction="row" spacing={2} justifyContent="flex-end" alignItems="center">
            ...
            <FM.FormButton style={{ backgroundColor: '#1E86FF' }} type="submit" variant="outlined" onClick={() => ctaUpdateHandler(handleCloseUpdate)}>
              Update
            </FM.FormButton>
          </Stack>
        </DialogActions>
