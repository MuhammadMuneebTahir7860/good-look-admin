...
import { doDeleteClient, doGetClients, doUpdateClient } from "../../redux/actions/ClientActions";
...
export function UseClients() {
  ...
  const ctaUpdateHandler = async (handleCloseUpdate) => {
    ...
    // dispatch(doUpdateClient(data, Toast, handleCloseUpdate, setSubmitLoading,user))
  }
