...
function EnhancedTableHead(props) {
    const { order, orderBy, onRequestSort, tableHeading } =
        props;
...
export default function NewTable({
    ...
    return (
        <Box sx={{ width: '100%' }}>
            <NewTableStyle.Paper>
                <EnhancedTableToolbar numSelected={selected.length} toolBarTitle={title} state={state} dispatch={dispatch} handleAnchorClick={handleAnchorClick} />
                                    ...
                                    return (
                                        <>
                                            ...
                                            >
                                                ...
                                                <TableCell align='left'>
                                                    <DeleteIcon onClick={() => deleteHandler(row?._id)} sx={{ color: 'red', marginRight: 2, cursor: 'pointer' }} />
                                                </TableCell>
                                            </TableRow>
                                        </>
                                    );
